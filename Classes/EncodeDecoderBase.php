...
abstract class EncodeDecoderBase {
	 ...
	 */
	protected function getFromAliasCacheByAliasValue(array $configuration, $aliasValue, $testNewAliasLanguage, $aliasValueId, $onlyNonExpired) {
		/** @noinspection PhpUndefinedMethodInspection */
		if (!empty($aliasValueId)) {
			$row = $this->databaseConnection->exec_SELECTgetSingleRow('value_id', 'tx_realurl_uniqalias',
					...
					' AND lang=' . intval($testNewAliasLanguage) .
					' AND value_id=' . intval($aliasValueId) .
