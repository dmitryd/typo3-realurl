...
class UrlDecoder extends EncodeDecoderBase implements SingletonInterface {
	 ...
	 *
	 * Currently this function uses 'hook_eofe' because this hook
	 * runs almost at the end and there was a chance for the encoder to put
	 * generated speaking url like this to the cache with proper parameters
	 * and cHash. This is better than other places because some plugins
	 * will create this link anyway with correct cHash.
	 */
